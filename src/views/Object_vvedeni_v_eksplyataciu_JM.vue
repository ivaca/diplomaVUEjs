  ...
  <v-app>
    <header>
      ...
      <v-container>
        <v-layout row wrap align-baseline justify-space-around>
          <v-flex col-sm-3 col-md-5 col-lg-5 col-12>
            <v-select
              :items="status"
    ...
    <v-container class="my-5" style=" padding: 0px;">
        ...
        <v-card outlined style="padding: 15px 15px 0px 15px ;">
          ...
          <v-layout row wrap fill-height align-baseline="">
            <v-flex col-sm-2 col-md-2 col-lg-2 col-12>
              ...
              <v-flex col-sm-2 col-md-2 col-lg-2 col-12>
                <v-text-field outlined :clearable="clearable" type="number" label="Заполнить в случае несоответствия" placeholder=" "></v-text-field>
              </v-flex>
             <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
      ...
      <v-container pa-2>
        ...
        <v-card outlined style="padding: 15px 15px 0px 15px;">
          ...
          <v-layout row wrap align-center="">
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <span>Вспомогательных помещений(лестничные клетки, коридоры, тамбуры, колясочные, щатовые и тп.), кв.м</span>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <v-text-field type="number" outlined :clearable="clearable"></v-text-field>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <span>Иных помещения(помещения, не вошедшие в вышеуказанные категории), кв.м</span>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <v-text-field type="number" outlined :clearable="clearable"></v-text-field>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <v-text-field label="Доп. помещения" outlined :clearable="clearable" placeholder=" "></v-text-field>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <v-text-field type="number" outlined :clearable="clearable"></v-text-field>
            </v-flex>
      ...
      <v-container pa-2>
        ...
        <v-card outlined style="padding: 15px 15px 0px 15px ;">
          <v-layout row wrap align-baseline>
            ...
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="material_sten" outlined single-line></v-select>
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <span>Материал перекрытий</span>
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="Material_karkasa" outlined single-line></v-select>
            </v-flex>
          </v-layout>
          <v-layout row wrap align-baseline>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
            ...
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="krovl_mat" outlined single-line></v-select>
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <span>Материал фундаментов</span>
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="found_mat" outlined single-line></v-select>
            </v-flex>
          </v-layout>
        </v-card>
      </v-container>
      ...
      <v-container pa-2>
        <v-layout justify-start mt-10>
          <v-flex col-sm-7 col-md-5 col-lg-5 col-xl-3 col-12>
        ...
        <v-card outlined style="padding: 15px 15px 0px 15px ;">
          <v-layout row wrap align-center>
            ...
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
              <Calendar outlined_field="true" label_prop="Дата составления акта" />
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <span>Тип документа, из которого внесена стоимость</span>
            </v-flex>
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="Tip_Docyment" outlined></v-select>
            </v-flex>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
            </v-flex>
          </v-layout>
          ...
          <v-layout row wrap align-baseline>
            ...
            <v-flex style="display:none;" class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12" id="date">
              <Calendar disabled outlined_field="true" />
            </v-flex>
          </v-layout>
          <v-layout row wrap align-baseline>
            <v-flex class="col-sm-2 col-md-2 col-lg-2 col-xl-2 col-12">
            ...
            <v-flex class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-12">
              <v-select :clearable="clearable" :items="Lvl_cen" outlined v-model="selected2" v-on:change="calendarik()"></v-select>
            </v-flex>
          ...
          <v-text-field
            ...
            outlined
            :clearable="clearable"
            label="В случае, если вы знакомы с объектом, укажите свое экспертное мнение о нем (не используется/вводился очередями/долгострой/смена профиля и др.)"
          ></v-text-field>
        </v-card>
      </v-container>
    </v-container>
    ...
    >
      ...
      <v-layout mb-3 class="fixed-buttons">
        ...
        <v-btn id="fileButton" style="width:138px;" dark medium rounded elevation-7 color="green">
          Файл
...
export default {
  ...
  methods: {
    numbersss: function() {
      this.numberss = this.numberss.replace(/[^0-9]/, '');
    },
  ...
  data: () => ({
    ...
    Material_karkasa: ["Металлоконструкции", "Железобетон (сборный или монолитный)", "Дерево", "Иное", "Нет данных"],
    krovl_mat: [
