...
export default {
  ...
  data() {
    return {
      dialog: false,
      headers: [
        { text: "№ Закрепления", value: "number", sortable: true },
        { text: "ID учащегося", value: "id_student", sortable: true },
        { text: "ID организации", value: "id_organization", sortable: true },
        {
          text: "ID руководителя от колледжа",
          value: "id_rukovod_col",
          sortable: true,
        },
        {
          text: "ФИО руководителя от организации",
          value: "fn_rukovod_org",
          sortable: true,
        },
        { text: "Телефон", value: "phone", sortable: true },
        { text: "Вид практики", value: "type_of_practice", sortable: true },
  ...
  methods: {
    initialize() {
      axios
        .post("http://localhost:3333/assigned_students")
        .then((res) => {
